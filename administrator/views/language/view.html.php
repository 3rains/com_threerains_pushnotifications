 ...
 * View to edit
 */
class Threerains_pushnotificationsViewLanguage extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_THREERAINS_PUSHNOTIFICATIONS_TITLE_LANGUAGE'), 'language.png');

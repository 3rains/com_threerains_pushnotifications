...
<script type="text/javascript">
    ...
    {
        if (task == 'deviceslist.cancel') {
            Joomla.submitform(task, document.getElementById('deviceslist-form'));
        }
        else {
            
            if (task != 'deviceslist.cancel' && document.formvalidator.isValid(document.id('deviceslist-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_threerains_pushnotifications&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="deviceslist-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_THREERAINS_PUSHNOTIFICATIONS_TITLE_DEVICESLIST', true)); ?>
        <div class="row-fluid">

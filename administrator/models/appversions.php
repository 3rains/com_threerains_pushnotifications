 ...
 */
class Threerains_pushnotificationsModelAppversions extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        parent::populateState('a.version_code', 'asc');
    }
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__threerains_pushnotifications_app_versions` AS a');
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.version_code LIKE '.$search.' )');
            }
        }

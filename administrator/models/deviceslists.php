 ...
 */
class Threerains_pushnotificationsModelDeviceslists extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        parent::populateState('a.list_name', 'asc');
    }
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__threerains_pushnotifications_devices_lists` AS a');
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.list_name LIKE '.$search.'  OR  a.list_description LIKE '.$search.' )');
            }
        }
